...
os.system(comando2)
comando3 = 'xcopy "'+filename+'/" "C:/Users/'+userr+'/Desktop/Copia de Seguridad/" /S /E /C'
os.system(comando3)
#print(comando)
#print(comando2)
#print(comando3)
...
exit()
"""
Futuras versiones que se abra el seleccionador de carpetas y que seleccione del disco, entonces que copie las carpetas de dentro excluyendo  las siguientes de la ruta C:\Users\ ;
- Public
- Default
